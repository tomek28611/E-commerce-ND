      ...
      <div class="container px-4 mx-auto">
        <div class="-mx-4 flex flex-wrap justify-between">
          ...
          <div class="px-4 my-4 w-full sm:w-auto">
            <div>
              <h2 class="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-600">Firma</h2>
            </div>
            <ul class="leading-8">
              <li><Link href="#" class="hover:text-blue-400">O nas</Link></li>
              <li><Link href="#" class="hover:text-blue-400">Podmínky</Link></li>
              <li><Link href="#" class="hover:text-blue-400">Zásady ochrany osobních údajů</Link></li>
              <li><Link href="#" class="hover:text-blue-400">Kontaktujte nás</Link></li>
            </ul>
          </div>
          <div class="px-4 my-4 w-full sm:w-auto">
            <div>
          ...
          <div class="px-4 my-4 w-full sm:w-auto xl:w-1/5">
            <div>
              <h2 class="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-600">Spojte se s námi</h2>
            </div>
            <Link href="#" class="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full mr-1 hover:text-blue-400 hover:border-blue-400">
            ...
            <Link href="#" class="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full hover:text-blue-400 hover:border-blue-400">
