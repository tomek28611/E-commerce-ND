      ...
      <div class="container px-4 mx-auto">
        <div class="-mx-4 flex flex-wrap justify-between">
          ...
          <div class="px-4 my-4 w-full sm:w-auto">
            ...
            <ul class="leading-8">
              <li><a href="#" class="hover:text-blue-400">O nas</a></li>
              <li><a href="#" class="hover:text-blue-400">Podmínky</a></li>
              <li><a href="#" class="hover:text-blue-400">Zásady ochrany osobních údajů</a></li>
              <li><a href="#" class="hover:text-blue-400">Kontaktujte nás</a></li>
            </ul>
          </div>
          <div class="px-4 my-4 w-full sm:w-auto">
            <div>
            ...
            <ul class="leading-8">
              <li><a href="#" class="hover:text-blue-400">xxx</a></li>
              <li><a href="#" class="hover:text-blue-400">xxx</a></li>
              <li><a href="#" class="hover:text-blue-400">xxx</a></li>
              <li><a href="#" class="hover:text-blue-400">xxx</a></li>
              <li><a href="#" class="hover:text-blue-400">xxx</a></li>
