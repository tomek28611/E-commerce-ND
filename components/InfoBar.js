...
export default function FooterBar() {
  ...
  return (
    <div
      className={`fixed left-0 right-0 mx-auto rounded-xl border bg-slate-200 text-balck dark:bg-gray-800 dark:text-white p-4 flex justify-between items-center shadow-md z-50 transition-all duration-1000 ${isAnimating
