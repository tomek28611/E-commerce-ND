...
export default function NewProducts({ products }) {
    ...
    return (
        <>
            <section className="items-center py-4 md:absolute relative right-4 top-40 p-12 bg-slate-100 dark:bg-slate-800 text-black dark:text-white">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <h2 className="font-manrope font-bold text-4xl text-black mb-8 max-xl:text-center">Nedávno přidáno</h2>
