        ...
        <>
            <section className="items-center py-4 md:absolute relative right-4 top-20 p-1 bg-slate-100 dark:bg-slate-800 text-black dark:text-white">
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mb-12">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 2xl:grid-cols-5 3xl:grid-cols-5 gap-3">
                        {products.map((product) => (
                            <div key={product._id} onClick={() => handleNavigation(product.title)}
                                ...
                                <div className="relative group">
                                    ...
                                    <div
                                        className="absolute z-10 bottom-3 left-0 mx-3 p-3 bg-slate-300 bg-opacity-50 w-[calc(100%-24px)] rounded-xl shadow-sm shadow-transparent overflow-hidden transition-all duration-500 h-12 group-hover:h-24 group-hover:shadow-indigo-200 group-hover:bg-indigo-50"
                                    >
