...
export default function ProductTypes({ setMenuOpen }) {
    ...
    return (
        <>
            <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-4 mb-4 mr-0 md:ml-6 lg:ml-8">
                <div
                    className="flex flex-col justify-end items-center bg-gray-800 text-white text-center p-2 rounded-lg cursor-pointer transition-all ease-in-out duration-300 h-24 w-full sm:w-32 md:w-24 bg-cover bg-center relative hover:bg-gray-600"
