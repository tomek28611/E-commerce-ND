...
export default async function handler(req, res) {
  ...
  if (req.method === 'POST') {
    try {
      ...
      // Send email to admin
      await transporter.sendMail({
        from: `"🚗 NÁHRADNÍ DÍLY Objednávka od klienta : ${req.body.name}" <autodilyobchod@gmail.com>`,
        to: 'tomek28611@gmail.com, autodilykr@gmail.com',
        subject: `Nova objednavka na díl: ${req.body.title}`,
        html: `
          <div style="font-family: Arial, sans-serif; background-color: #f7f7f7; padding: 20px; border-radius: 18px;">
            <div style="text-align: center;">
              ...
              <h1 style="color: #333;"> NÁHRADNÍ DÍLY</h1>
            </div>
            <table style="width: 100%; margin-top: 20px; border-collapse: collapse;">
              <tr style="background-color: #fff; border: 1px solid #ddd;">
                <td style="padding: 10px; text-align: center;"><strong>Jméno:</strong> ${req.body.name}</td>
              ...
              <tr style="background-color: #fff; border: 1px solid #ddd;">
                <td style="padding: 10px; text-align: center;"><strong>Mesto</strong> ${req.body.city || 'Neuvedeno'}</td>
              </tr>
              <tr style="background-color: #fff; border: 1px solid #ddd;">
                <td style="padding: 10px; text-align: center;"><strong>ul:</strong> ${req.body.street || 'Neuvedeno'}</td>
              </tr>
                  <tr style="background-color: #fff; border: 1px solid #ddd;">
                <td style="padding: 10px; text-align: center;"><strong>PSC</strong> ${req.body.postalCode || 'Neuvedeno'}</td>
              </tr>
              <tr style="background-color: #fff; border: 1px solid #ddd;">
                <td style="padding: 10px; text-align: center;"><strong>Zpráva:</strong></td>
              </tr>
      ...
      await transporter.sendMail({
        ...
        to: clientEmail, 
        subject: 'Potvrzení o přijetí Objednávky', 
        html: `
          <div style="font-family: Arial, sans-serif; background-color: #f7f7f7; padding: 20px; border-radius: 18px;">
           <div style="text-align: center;">
              <img src="https://moto-rental.s3.amazonaws.com/1730277855197.png" alt="Logo NÁHRADNÍ DÍLY" style="width: 150px; margin-bottom: 20px;">
            ...
            <h1 style="color: #333; text-align: center;">Děkujeme za Vaši objednávku!</h1>
