    ...
    return (
        <>
            <Head>
                ...
                <title>Náhradní díly pro Mercedes Benz A třídy</title>
                <meta
                    name="description"
            ...
            <div className="dark:bg-slate-700">
                <h1 className="text-center mb-4 font-manrope font-bold text-2xl dark:text-slate-200">Náhradní díly pro model Mercedes-Benz Třída-A</h1>
