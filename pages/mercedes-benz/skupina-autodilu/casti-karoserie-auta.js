    ...
    return (
        <>
            <Head>
                ...
                <title>Části karoserie auta</title>
                <meta
                    name="description"
            ...
            <div className="dark:bg-slate-700">
                <h1 className="text-center mb-4 font-manrope font-bold text-2xl dark:text-slate-200">Náhradní díly Části karoserie auta</h1>
