    ...
    return (
        <>
            ...
            <section className="bg-gray-300 text-gray-800 p-6 rounded-lg shadow-lg max-w-3xl mx-auto">
                ...
                <ul className="list-disc list-inside mb-4">
                    <li><strong>Amortizátory (tlumiče):</strong> Amortizátory jsou základními komponenty každého zavěšení, které tlumí nárazy a vibrace přenášené na vozidlo. Mercedes-Benz používá tlumiče s různými technologiemi, včetně hydraulických a elektronicky řízených tlumičů, které upravují tuhost v závislosti na jízdních podmínkách.</li>
