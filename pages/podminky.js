        ...
        <div class="bg-gray-100 dark:bg-gray-800">
          <div class="min-h-screen flex flex-col justify-center items-center">
            ...
            <div class="flex space-x-4">
              ...
              <a href="https://www.nahradni-dily.com/o-nas" class="border-2 border-gray-800 text-black font-bold py-3 px-6 rounded dark:text-white dark:border-white">Znovu načíst</a>
            </div>
          </div>
        </div>
      </div>
